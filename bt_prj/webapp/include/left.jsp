        ...
        <aside id="sidebar-wrapper">
          ...
          <div class="sidebar-user">
            ...
            <div class="sidebar-user-picture">
                <c:choose>	
                	<c:when test="${sessionScope.SESS_GUBUN != null}">
		             		 <img alt="${sessionScope.SESS_NAME}" 
		           				src="/cdir/${sessionScope.SESS_PROFILE_IMG}">
		             	</c:when>
		             	<c:otherwise>
		             		<img alt="손님" 
		           			src="/img/avatar/left_top_pic.png">
		             	</c:otherwise>
		           </c:choose>
            </div>
            ...
            <div class="sidebar-user-details">
              <div class="user-name">
              	<b>${sessionScope.SESS_NAME}</b>
              </div>
              <div class="user-role">
                	권한 :
                	<c:if test="${sessionScope.SESS_GUBUN == 'a'}">
                		(관리자)
                	</c:if>
                	<c:if test="${sessionScope.SESS_GUBUN == 'u'}">
                		(사용자)
                	</c:if>
